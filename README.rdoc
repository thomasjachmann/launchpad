...
{<img src="https://travis-ci.org/thomasjachmann/launchpad.png" />}[https://travis-ci.org/thomasjachmann/launchpad]
...
* refactor interaction multithreading
* test on 1.8.7 and 2.0.0
