...
* Novation's programmers reference describing the MIDI messages to exchange with launchpad at http://www.novationmusic.com/support/launchpad/ (bottom of the page)
